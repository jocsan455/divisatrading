                ...
                <div class="slide-single position-relative full-height bg-cover" style="background-image: url(assets/images/slide1.jpg)">
                    ...
                    <div class="caption-content dp-table">
                        <div class="tbl-cell text-center position-relative">
                            <h1 class="font-700 color-white animated fadeInDown text-uppercase">PROGRAMA DE <br><span class="color-base">INVERSIÓN EN DIVISAS</span></h1>
                            <h3 class="font-600 m-0 color-white animated fadeInDown">Superamos constantemente la rentabilidad de hedge funds,<br> índices bursátiles y productos cotizados.</h3>
                ...
                <div class="slide-single position-relative full-height bg-cover" style="background-image: url(assets/images/slider2.jpeg)">
                    ...
                    <div class="caption-content dp-table" style="margin-left: 5%;">
                        <div class="tbl-cell text-left position-relative">
                            ...
                            <h3 class="font-600 m-0 color-white animated fadeInDown">Generamos beneficios en cualquier ciclo de mercado<br>y sin exceder la tolerancia al riesgo de los inversores.
</h3>
                            <div class="large-btn">
                ...
                <div class="slide-single position-relative full-height bg-cover" style="background-image: url(assets/images/slider3.png)">
                    ...
                    <div class="caption-content dp-table" style="margin-left: -5%;">
                        <div class="tbl-cell text-right position-relative">
                            <h1 class="font-700 color-white text-uppercase"><span class="color-base">NUESTRA MISIÓN:</span> <br> SU SATISFACCIÓN</h1>
                            <h3 class="font-600 m-0 color-white animated fadeInDown">Nos enfocamos intensamente en la mejora continua<br>de nuestros productos y servicios, para satisfacer<br>y exceder las expectativas de los inversores.</h3>
                            <div class="large-btn">
                                <a target="_blank" class="color-bg" href="https://keytomarkets.com/en/live-account/?lid=19&pid=5911">Abrir cuenta</a><a href="#Contacto">Contacto</a>
                            </div>
                        </div>
                ...
                <div class="slide-single position-relative full-height bg-cover" style="background-image: url(assets/images/slider4.jpg)">
                    ...
                    <div class="caption-content dp-table">
                        <div class="tbl-cell text-center position-relative">
                            ...
                            <h3 class="font-600 m-0 color-white animated fadeInDown">Nuestras transacciones son efectuadas desde New York,<br>Equinix 4, a través de KEY TO MARKETS, uno de los más<br>sólidos y prestigiosos brókeres de forex del mundo</h3>
                            <div class="large-btn animated fadeInUp">
                                <a target="_blank" class="color-bg" href="https://keytomarkets.com/en/live-account/?lid=19&pid=5911">Abrir cuenta</a><a href="#Contacto">Contacto</a>
                            </div>
                        </div>
                ...
                <div class="slide-single position-relative full-height bg-cover" style="background-image: url(assets/images/slider5.jpg)">
                    ...
                    <div class="caption-content dp-table" style="margin-left: 5%;">
                        <div class="tbl-cell text-left position-relative">
                            ...
                            <h1 class="font-700 color-white text-uppercase"><span class="color-base">TECNOLOGÍA EFICAZ</span> <br> PLATAFORMA PAMM</h1>
                            <h3 class="font-600 m-0 color-white animated fadeInDown">Nuestros inversores pueden personalizar su nivel de riesgo,<br>proteger su capital y retirar sus fondos cuando lo deseen.</h3>
                            <div class="large-btn">
                                <a target="_blank" class="color-bg" href="https://keytomarkets.com/en/live-account/?lid=19&pid=5911">Abrir cuenta</a><a href="#Contacto">Contacto</a>
                            </div>
                        </div>
                ...
                <div class="slide-single position-relative full-height bg-cover" style="background-image: url(assets/images/slider6.jpg)">
                    ...
                    <div class="caption-content dp-table" style="margin-left: 5%;">
                        <div class="tbl-cell text-left position-relative">
                            ...
                            <h1 class="font-700 color-white text-uppercase"><span class="color-base">LA FUSIÓN PERFECTA</span> <br> TRADER & ROBOT</h1>
                            <h3 class="font-600 m-0 color-white animated fadeInDown">Los robots aún no toman mejores decisiones que un<br> trader experto, pero ningún trader es tan preciso <br>y disciplinado como un Robot.
</h3>
                            <div class="large-btn">
                                <a target="_blank" class="color-bg" href="https://keytomarkets.com/en/live-account/?lid=19&pid=5911">Abrir cuenta</a><a href="#Contacto">Contacto</a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-content">
                            ...
                            <strong>2)</strong> Deposite mínimo 500 USD, en su nueva cuenta de inversiones. <br>
...
sus asociados e inversionistas.</p>
...
<div class="modal fade modal1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <p class="text-justify">Como compensación económica por su servicio profesional de manejo de inversiones en el mercado de divisas, “EL PAMM MANAGER” cobrará una comisión porcentual (Performance Fee) del 50% que será aplicada a los beneficios netos obtenidos al término de cada mes.</p>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <p>SI USTED NO ENCUENTRA LA RESPUESTA A SU PREGUNTA ESPECÍFICA, POR FAVOR,<br> COMUNÍQUESE CON NOSOTROS A TRAVÉS DEL EMAIL: 
        ...
        <p class="text-justify">Invertimos en los siguientes cruces de divisas: GBPUSD, EURUSD, EURJPY, EURGBP, USDJPY, USDCAD, USDCHF, AUDUSD, AUDJPY, AUDCAD y NZDUSD.</p>
        ...
        <p class="text-justify">Depende de la volatilidad del mercado y de la formación de los criterios de entrada previstos en nuestra estrategia de trading. No obstante, por lo regular abrimos alrededor de 25 operaciones semanales.</p>
        <strong class="text-left block">¿Cuántos trades mantienen abiertos simultáneamente?</strong>
        <p class="text-justify">Depende de las condiciones del mercado, pero en días de mucha actividad, en determinados momentos podrían haber abiertas entre 10 y 30 operaciones.</p>
        ...
        <p class="text-justify">Su depósito inicial deberá ser minimo de 500 USD. No hay límites para el monto máximo que usted desee invertir.</p>
